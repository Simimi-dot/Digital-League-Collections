...
var iceMageGuild = listOfWizard.filter { magician in
    return magician.magicPower == .iceMagic
}.sorted { (firstMagician, secondMagician) -> Bool in
    return firstMagician.level > secondMagician.level
}



//for power in iceMageGuild {
